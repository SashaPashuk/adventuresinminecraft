const ordersHistoryContainerElements=document.querySelector(".orderHistory-orders"),renderOrderHistoryItems=r=>{let s="";r.forEach(({})=>{s+=`
    ...
    `}),ordersHistoryContainerElements.innerHTML=s},ordersHistoryElements=(renderOrderHistoryItems([1,2,3]),document.querySelectorAll(".orderHistory-orders-order-container"));ordersHistoryElements?.forEach(o=>{o.querySelector("#arrow-order-button")?.addEventListener("click",()=>{var r=o?.querySelector(".orderHistory-orders-order-details"),s=o?.querySelector("hr"),e=o?.querySelector(".orderHistory-orders-order-actions-arrow");s.classList.toggle("hidden"),r.classList.toggle("hidden"),e.classList.toggle("orderHistory-orders-order-actions-arrow-open")})});